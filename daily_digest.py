...
2. 使用台灣繁體中文；人名與重要專有名詞第一次出現時保留英文。不可補充輸入未提供的事實。
3. 只輸出合法JSON，不要Markdown，不要額外說明。所有source_id只能使用輸入提供的id。

以下是我覺得重要跟不重要的部分，請你按照相似邏輯來進行篩選：

像是以下Headline類型請幫我刪除：
市場估計中國人民銀行可能將人民幣兌美元中間價設定在6.7734元。-->不會對市場造成影響
日本財務大臣片山皋月表示，不會評論特定匯率水準。-->除非他提到要干預，不然也不會對市場造成影響
台股跌幅超過2.7%。-->純講價格/漲跌幅 不重要
川普開始發表全國演說。-->沒有演說內容 不重要
白宮表示，情報顯示中國為這項新計畫專門成立一個資料利用單位。-->對市場沒有意義
中國商務部表示，將密切關注British Steel事件發展，並支持中國企業依法維護權益。-->對市場沒有意義
中國國家主席習近平表示，中國將人工智慧發展安全列為優先事項。-->中國官方說的話，除非提到關稅、貨幣政策及財政支出，都不會對市場造成影響
30日相關係數矩陣。、標普500主要成分股隱含波動率。、外匯隱含波動率。-->沒意義



以下Headline非常重要：
美國、中國、台灣、歐洲、英國、韓國、日本、澳洲中央銀行官員談話，內容有提到升降息或勞動市場或通膨的
報導稱谷歌Gemini旗艦模型發布延期，導致Alphabet股價重挫5%。-->這種有明確提到因為某個原因造成股價下跌的
伊朗已要求胡塞武裝，若美國攻擊伊朗電力網絡，即封鎖紅海石油航線。-->這種戰爭有可能升級擴大的
